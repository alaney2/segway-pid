...
impl Guy {
  pub fn update(&mut self, segway: &crate::segway::Segway, _delta_time: f32, gui: &Gui) {
    self.height = 220.0 * gui.ui_scale;
...
pub fn init_guy(segway: &crate::segway::Segway, gui: &crate::gui::Gui) -> Guy {
  let height = 220.0 * gui.ui_scale;
  Guy {
    tilt_angle: 0.0,
